...
import { aleatorio } from "./pergunta.js";
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "No início ficou com medo de criar um clone digital e causar o caos no parque.",
                    "Decidiu ter cautela com a tecnologia para evitar que o robô assuma suas funções."
                ]
            },
            {
                texto: "Isso é maravilhoso! Nunca mais vamos precisar pensar!",
                afirmacao: [
                    "Se empolgou com a ideia de usar IA para facilitar as tarefas do dia a dia.",
                    "Aproveitou o tempo livre para jogar videogame enquanto a máquina faz o serviço."
                ]
            }
        ]
    },
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Conseguiu usar a IA como ferramenta de estudo para entregar o trabalho sem levar bronca do Benson.",
                    "Aprendeu a otimizar o tempo de trabalho sem deixar de entender o conteúdo."
                ]
            },
            {
                texto: "Escrever o relatório conversando com o Saltitão, o Pairulito e usando seus próprios conhecimentos do parque.",
                afirmacao: [
                    "Preferiu confiar nos próprios recursos e no conhecimento da galera do parque.",
                    "Manteve a tradição do trabalho em equipe valorizando a experiência dos amigos."
                ]
            }
        ]
    },
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Defendeu que a inovação pode abrir novos caminhos e melhorar o trabalho no parque.",
                    "Mostrou uma visão otimista de como humanos e máquinas podem colaborar."
                ]
            },
            {
                texto: "Se preocupar com o Benson substituindo todos por robôs e defender a proteção aos trabalhadores.",
                afirmacao: [
                    "Lutou pela importância do trabalho humano e por discussões éticas sobre tecnologia.",
                    "Reforçou que a empatia e a convivência do grupo jamais serão substituídas."
                ]
            }
        ]
    },
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Mostrou que dominar ferramentas tradicionais ainda tem seu valor e ensinou os outros no parque.",
                    "Valorizou o esforço manual e a criatividade feita do seu próprio jeito."
                ]
            },
            {
                texto: "Usar um gerador de imagens por IA para criar o cartaz em três segundos.",
                afirmacao: [
                    "Usou a tecnologia para acelerar o processo criativo e surpreender a todos com imagens incríveis.",
                    "Descobriu novas formas de arte digital e entregou o projeto em tempo recorde."
                ]
            }
        ]
    },
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "Infelizmente virou dependente da tecnologia e quase destruiu o parque no processo!",
                    "Aprendeu da pior forma que copiar e colar cegamente sempre gera confusão."
                ]
            },
            {
                texto: "Desligar o roteador, revisar o texto inteiro e corrigir os erros da máquina antes que o portal abra.",
                afirmacao: [
                    "Percebeu que toda máquina erra e que o pensamento crítico humano é essencial para não causar o caos.",
                    "Salvou o parque no último segundo assumindo o controle total sobre a tarefa."
                ]
            }
        ]
    }
